...
url = "https://www.olx.ba/pretraga?kategorija=18&sort_order=desc&do=15100&godiste_min=2011&kilometra-a_max=131000&gorivo_select_benzin=Benzin&gorivo_select_plin=Plin&stranica="
...
def main():
    ...
    if len(deleted_urls_to_mail) != 0 or len(new_urls_to_mail) != 0:
        helper_methods.send_email("emir.hodzic@outlook.com", 'NovaSifr@123', "emir.hodzich@gmail.com", "OLX update", email_body)
